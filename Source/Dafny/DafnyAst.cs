...
namespace Microsoft.Dafny {
  ...
  public class BuiltIns
  {
    ...
    public BuiltIns() {
      ...
      if (Translator.FrugalHeapUse && DafnyOptions.O.DafnyPrintResolvedFile == /*can drop this requirement; would need to update various .dfy.expect files*/ null) {
        ...
        var rankFun = new Function(Token.NoToken, "rank_is_less_than", false, Usage.Ghost,
    ...
    private void CreateArrowTypeDeclInternal(int arity, Usage resultUsage, List<Usage> usages) {
      ...
      if (!ArrowTypeDecls.ContainsKey(key)) {
        ...
        var req = new Function(tok, "requires", false, Usage.Ghost,
          ...
          null, null, null);
        var reads = new Function(tok, "reads", false, Usage.Ghost,
  ...
  public class AliasModuleDecl : ModuleDecl
  {
    ...
    public ModuleFormal Formal; // Non-null if this is a fake alias representing a functor's formal argument
  ...
  // An actual argument passed to a functor
  public abstract class ModuleActual {
    public abstract override bool Equals(Object obj);

    public abstract override int GetHashCode();
  }

  // The actual is a module declaration
  public class ModuleActualDecl : ModuleActual {
    public ModuleDecl decl;

    public ModuleActualDecl(ModuleDecl decl) {
      this.decl = decl;
    }

    public override bool Equals(Object obj) {
      if (obj == null || ! (obj is ModuleActualDecl))
        return false;
      else
        return decl == ((ModuleActualDecl) obj).decl;
    }
    ...
    public static bool operator ==(ModuleActualDecl lhs, ModuleActualDecl rhs) {
      if (lhs is null) {
        if (rhs is null) {
          return true;
        }
    ...
    public static bool operator !=(ModuleActualDecl lhs, ModuleActualDecl rhs) => !(lhs == rhs);
  }

  // The actual is a formal argument to the enclosing functor
  public class ModuleActualFormal : ModuleActual {
    public ModuleFormal formal;

    public ModuleActualFormal(ModuleFormal formal) {
      this.formal = formal;
    }

    public override bool Equals(Object obj) {
      if (obj == null || ! (obj is ModuleActualFormal))
        return false;
      else
        return formal == ((ModuleActualFormal) obj).formal;
    }

    public override int GetHashCode() {
      return formal.GetHashCode();
    }

    public static bool operator ==(ModuleActualFormal lhs, ModuleActualFormal rhs) {
      if (lhs is null) {
        if (rhs is null) {
          return true;
        }
    ...
    public static bool operator !=(ModuleActualFormal lhs, ModuleActualFormal rhs) => !(lhs == rhs);
  }
  ...
  public class FunctorApplication {
    ...
    public List<ModuleActual> moduleParams;  // Actual module arguments to the functor.  Filled in during resolution
  ...
  public class ModuleFormal
  {
    ...
    public ModuleDecl TypeDecl;       // The actual module "type" of the formal.  Filled in during resolution
    ...
    public override bool Equals(Object obj) {
      if (obj == null || !(obj is ModuleFormal)) {
        return false;
      } else {
        var other = (ModuleFormal) obj;
  ...
  public abstract class MemberDecl : Declaration {
    ...
    public MemberDecl(IToken tok, string name, bool hasStaticKeyword, Usage usage, Attributes attributes, bool isRefining)
      : base(tok, name, attributes, isRefining) {
      Contract.Requires(tok != null);
      Contract.Requires(name != null);
  ...
  public class Field : MemberDecl {
    ...
    public Field(IToken tok, string name, bool hasStaticKeyword, bool isGhost, bool isMutable, bool isUserMutable, Type type, Attributes attributes)
      : base(tok, name, hasStaticKeyword, isGhost ? Usage.Ghost : Usage.Ordinary, attributes, false) {
      Contract.Requires(tok != null);
      Contract.Requires(name != null);
      Contract.Requires(type != null);
  ...
  public class NativeType
  {
    ...
    public enum Selection { Byte, SByte, UShort, Short, UInt, Int, Number, ULong, Long, UInt128 }
  ...
  public class Function : MemberDecl, TypeParameter.ParentType, ICallable {
    ...
    /// </summary>
    public Function(IToken tok, string name, bool hasStaticKeyword, Usage usage,
  ...
  public class Predicate : Function
  {
    ...
    public Predicate(IToken tok, string name, bool hasStaticKeyword, Usage usage,
      List<TypeParameter> typeArgs, List<Formal> formals,
      List<AttributedExpression> req, List<FrameExpression> reads, List<AttributedExpression> ens, Specification<Expression> decreases,
      Expression body, BodyOriginKind bodyOrigin, Attributes attributes, IToken signatureEllipsis)
      : base(tok, name, hasStaticKeyword, usage, typeArgs, formals, null, Type.Bool, req, reads, ens, decreases, body, attributes, signatureEllipsis) {
  ...
  public class PrefixPredicate : Function
  {
    ...
    public PrefixPredicate(IToken tok, string name, bool hasStaticKeyword,
      ...
      : base(tok, name, hasStaticKeyword, Usage.Ghost, typeArgs, formals, null, Type.Bool, req, reads, ens, decreases, body, attributes, null) {
  ...
  public abstract class ExtremePredicate : Function
  {
    ...
    public ExtremePredicate(IToken tok, string name, bool hasStaticKeyword, KType typeOfK,
      ...
      Expression body, Attributes attributes, IToken signatureEllipsis)
      : base(tok, name, hasStaticKeyword, Usage.Ghost, typeArgs, formals, null, Type.Bool,
  ...
  public class TwoStateFunction : Function
  {
    ...
    public TwoStateFunction(IToken tok, string name, bool hasStaticKeyword,
                     ...
                     List<AttributedExpression> req, List<FrameExpression> reads, List<AttributedExpression> ens, Specification<Expression> decreases,
                     Expression body, Attributes attributes, IToken signatureEllipsis)
      : base(tok, name, hasStaticKeyword, Usage.Ghost, typeArgs, formals, result, resultType, req, reads, ens, decreases, body, attributes, signatureEllipsis) {
      Contract.Requires(tok != null);
      Contract.Requires(name != null);
      Contract.Requires(typeArgs != null);
  ...
  public class Method : MemberDecl, TypeParameter.ParentType, IMethodCodeContext
  {
    ...
    public Method(IToken tok, string name,
      ...
      : base(tok, name, hasStaticKeyword, usage, attributes, signatureEllipsis != null) {
      Contract.Requires(tok != null);
      Contract.Requires(name != null);
      Contract.Requires(cce.NonNullElements(typeArgs));
  ...
  */
  ...
  public class ApplySuffix : SuffixExpr {
    ...
    public ApplySuffix(IToken tok, IToken/*?*/ atLabel, Expression lhs, List<ApplySuffixArg> args)
      : base(tok, lhs) {
      Contract.Requires(tok != null);
      Contract.Requires(lhs != null);
      Contract.Requires(cce.NonNullElements(args));
