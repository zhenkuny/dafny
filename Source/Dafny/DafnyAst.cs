...
namespace Microsoft.Dafny {
  ...
  {
    public readonly ModuleExpression ModExp; // generated by the parser, this is looked up
    ...
    public AliasModuleDecl(ModuleExpression modexp, IToken name, ModuleDefinition parent, bool opened, List<IToken> exports)
      : base(name, name.val, parent, opened, false) {
       Contract.Requires(modexp != null && !modexp.IsDegenerate());
       Contract.Requires(exports != null);
       Contract.Requires(exports.Count == 0 || modexp.IsSimpleName());
       ModExp = modexp;
       Exports = exports;
    }
  ...
  public class AbstractModuleDecl : ModuleDecl
  {
    ...
    public AbstractModuleDecl(ModuleExpression modexp, IToken name, ModuleDefinition parent, bool opened, List<IToken> exports)
      : base(name, name.val, parent, opened, false) {
      Contract.Requires(modexp != null && !modexp.IsDegenerate());
      Contract.Requires(exports != null);
      Contract.Requires(exports.Count == 0 || modexp.IsSimpleName());
  ...
  public class ModuleDefinition : INamedRegion, IAttributeBearingDeclaration
  {
    ...
    public ModuleDefinition(IToken tok, string name, List<IToken> prefixIds, bool isAbstract, bool isFacade,
      ModuleExpression refinementBaseExpr, ModuleQualifiedId refinementQId,
      ...
      bool isToBeVerified, bool isToBeCompiled)
    {
      ...
      this.RefinementBaseExpr = refinementBaseExpr;
