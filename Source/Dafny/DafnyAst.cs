...
namespace Microsoft.Dafny {
  ...
  {
    public /*readonly XXX fixme*/ ModuleDefinition ModuleDef;
  ...
  {
    public readonly ModuleExpression TargetModExp; // generated by the parser, this is looked up
    ...
    public AliasModuleDecl(ModuleExpression targetModExp, IToken name, ModuleDefinition parent, bool opened, List<IToken> exports)
      : base(name, name.val, parent, opened, false) {
       Contract.Requires(targetModExp != null && !targetModExp.IsDegenerate());
       Contract.Requires(exports != null);
       Contract.Requires(exports.Count == 0 || targetModExp.IsSimpleName());
       TargetModExp = targetModExp;
       Exports = exports;
    }
  ...
  // Common elements of a ModuleQualifiedId and a ModuleExpression
  // XXX TODO(jonh) I think eventually we're going to have ModuleExpression do
  // all the work of ModuleQualifiedId (including export set behavior), and
  // we'll just often expect restricted ModuleExpressions (that are only paths,
  // no application parameters).
  public class ModuleResolutionInfo {
    protected void CloneInto(ModuleResolutionInfo cl, bool includeResInfo) {
      if (includeResInfo) {
        cl.Root = this.Root;
        cl.Decl = this.Decl;
        cl.Def = this.Def;
    ...
    public void SetFromModuleDecl(ModuleDecl m) {
      if (m == null) {
        this.Decl = null;
        this.Def = null;
        this.Sig = null;
  ...
  public class ModuleExpression : ModuleResolutionInfo
  {
    ...
    public static ModuleExpression From(ModuleQualifiedId qId) {
      ...
      if (qId.Root!=null) {
        result.SetRoot(qId.Root);
        result.Sig = qId.Root.Signature;  // XXX why not qId.Signature? It's null when I looked. HRmm.
      }
      return result;
    }
  ...
  public class ModuleQualifiedId : ModuleResolutionInfo {
  ...
  public class ModuleDefinition : INamedRegion, IAttributeBearingDeclaration
  {
    ...
    private ModuleExpression _refinementBaseModExp;
    public ModuleExpression RefinementBaseModExp {
      get { return _refinementBaseModExp; }
      set {
        // "lazy read-only" -- grammar can't set this at ctor time.
        Contract.Assert(_refinementBaseModExp == null);
        _refinementBaseModExp = value;
      }
    }
    ...
    public ModuleDefinition(IToken tok, string name, List<IToken> prefixIds, bool isAbstract, bool isFacade,
      ModuleExpression refinementBaseModExp,
      ...
      bool isToBeVerified, bool isToBeCompiled)
    {
      ...
      this.Attributes = attributes;
      this.RefinementBaseModExp = refinementBaseModExp;
      this.EnclosingModule = parent;
      this.ModuleRequiresConstraints = new List<ModuleExpressionPair>();
