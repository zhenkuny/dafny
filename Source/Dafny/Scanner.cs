...
//      if (ch == EOL) { line++; col = 0; }
  ...
  public void CheckLiteral() {
		switch (t.val) {
			...
			case "include": t.kind = 95; break;
			case "abstract": t.kind = 96; break;
			case "module": t.kind = 97; break;
			case "refines": t.kind = 98; break;
			case "opened": t.kind = 99; break;
			case "provides": t.kind = 101; break;
			case "reveals": t.kind = 102; break;
			case "extends": t.kind = 103; break;
			case "new": t.kind = 104; break;
			case "yields": t.kind = 105; break;
			case "returns": t.kind = 106; break;
			case "comethod": t.kind = 110; break;
			case "free": t.kind = 111; break;
			case "yield": t.kind = 112; break;
			case "label": t.kind = 116; break;
			case "break": t.kind = 117; break;
			case "where": t.kind = 118; break;
			case "return": t.kind = 119; break;
			case "if": t.kind = 121; break;
			case "while": t.kind = 122; break;
			case "assert": t.kind = 123; break;
			case "print": t.kind = 124; break;
			case "forall": t.kind = 125; break;
			case "parallel": t.kind = 126; break;
			case "modify": t.kind = 127; break;
			case "exists": t.kind = 145; break;
			case "false": t.kind = 151; break;
			case "true": t.kind = 152; break;
			case "null": t.kind = 153; break;
			case "this": t.kind = 154; break;
			case "fresh": t.kind = 155; break;
			case "allocated": t.kind = 156; break;
			case "unchanged": t.kind = 157; break;
			case "old": t.kind = 159; break;
			default: break;
		}
  }
